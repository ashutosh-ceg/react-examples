...
This repository contains different kind of react project examples which demonstrate how to use components of react.

## How to use

The code snapshots are organized in multiple **branches** where every branch **represents a example section**.
...
![Click on the branch dropdown and then select the appropriate branch for the code example section you're looking for](./selecting-a-branch.jpg)
